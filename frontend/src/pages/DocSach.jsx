...
export default function DocSach() {
    ...
    useEffect(() => { ref_trang.current = trang_hien_tai; }, [trang_hien_tai]);
    useEffect(() => { ref_tong_trang.current = tong_so_trang; }, [tong_so_trang]);
        ...
        <div className={`trang_doc_sach ${che_do_toi ? 'che_do_toi' : ''}`}>
            ...
            <div className="thanh_cong_cu_doc">
                ...
                <div className="nhom_nut_cong_cu">
                    ...
                    <button className="nut_cong_cu" onClick={thu_nho} disabled={ti_le_phong_to <= 0.5} title="Thu nhỏ">
                        −
                    </button>
                    <span className="ti_le_phong_to">{Math.round(ti_le_phong_to * 100)}%</span>
                    <button className="nut_cong_cu" onClick={phong_to} disabled={ti_le_phong_to >= 2.0} title="Phóng to">
                        +
                    </button>
                </div>
            </div>
