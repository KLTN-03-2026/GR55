  ...
  return (
    <div className="trang_dang_nhap">
      <div className="hop_dang_nhap">
        ...
        {loi_server && <div className="thong_bao_server_loi">{loi_server}</div>}

        <form onSubmit={xu_ly_dang_nhap} noValidate>
          <div className="nhom_truong">
            <label className="nhan_truong" htmlFor="email">
              Email
            </label>
            <input
              id="email"
          ...
          <div className="nhom_truong">
            <label className="nhan_truong" htmlFor="mat_khau">
              Mật khẩu
            </label>
        ...
        <div className="khu_vuc_dang_ky">
          Chưa có tài khoản?{" "}
          <Link to="/dang_ky" className="lien_ket_dang_ky">
            Đăng ký
          </Link>
        </div>
      </div>
