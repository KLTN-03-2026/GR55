    ...
    useEffect(() => {
        ...
        script.onload = async () => {
            ...
            try {
                ...
                const gioi_han = so_trang_doc_thu > 0
        ...
        <div className={`trang_doc_thu ${che_do_toi ? 'che_do_toi' : ''}`}>
            ...
            <div className="thanh_cong_cu_doc">
                ...
                <span className="ten_sach_doc" title={chi_tiet_sach?.ten_sach}>
                    ...
                    {so_trang_doc_thu > 0 && (
                        <span className="nhan_doc_thu">Đọc thử — {so_trang_doc_thu} trang</span>
                    )}
                </span>
                <div className="nhom_nut_cong_cu">
                    ...
                    <button className="nut_cong_cu" onClick={thu_nho} disabled={ti_le_phong_to <= 0.5}>−</button>
                    <span className="ti_le_phong_to">{Math.round(ti_le_phong_to * 100)}%</span>
                    <button className="nut_cong_cu" onClick={phong_to} disabled={ti_le_phong_to >= 2.0}>+</button>
                </div>
            </div>
            ...
            {hien_banner && (
                <div className="banner_het_doc_thu">
                    <span>Bạn đã đọc hết {so_trang_doc_thu} trang thử. Mua sách để đọc tiếp!</span>
